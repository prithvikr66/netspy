      ...
      <div className=" bg-gray-900 h-screen ">
          ...
          <nav class="bg-white border-gray-200 dark:bg-gray-900">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
              <a href="" class="flex items-center space-x-3 rtl:space-x-reverse">
                <TbSpy className=" text-4xl text-white"/>
                <span class="self-center text-2xl font-extrabold whitespace-nowrap dark:text-white">NetSpy</span>
              </a>
              ...
              <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-cta">
                <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                  ...
                  <li>
                    <a href="#" class="block py-2 px-3 md:p-0 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 d:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Explore</a>
                  </li>
                  <li>
        ...
        <div className=" w-full flex items-center justify-center flex-col font-Poppins font-bold mt-16">
          <img src="https://media.tenor.com/x8v1oNUOmg4AAAAd/rickroll-roll.gif"
            alt="https://netspy-server.vercel.app/api/flag/1"
            className=" w-80 mx-auto"
          />
        <div className=" mt-8 flex flex-col gap-3">
        <h2 className="text-white text-3xl mx-auto">Hey, Did you just get RickRolled..?</h2>
          <h3 className=" text-white text-3xl">No, Not yet ..let's have a closer look at this website</h3>
        </div>
        </div>
      </div>
